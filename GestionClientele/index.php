            ...
            <nav class="nav bd-container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="Vue/produits.php" class="nav__link">Médicaments</a></li>
                        <li class="nav__item"><a href="Vue/parfumerie.php" class="nav__link">Hygiénes & Beauté</a></li>
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        ...
                        <a href="vue/inscription.php" class="button">Continuer en tant qu'employé </a>
                    </div>
